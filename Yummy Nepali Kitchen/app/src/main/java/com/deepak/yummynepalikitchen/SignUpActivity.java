    ...
    public void OnButtonClick() {
        ...
        username.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("1. Should be 6 characters long")
                        .setCancelable(false)
            ...
            public void onClick(View v) {
                ...
                PostResponseAsyncTask taskInsert = new PostResponseAsyncTask(SignUpActivity.this, postData, new AsyncResponse() {
                    ...
                    public void processFinish(String s) {
                        ...
                        else if (s.contains("failed") || uN.getText().toString().length() < 6 || pW.getText().toString().length() < 6 || phoneNum.getText().toString().length() != 10) {
                            AlertDialog.Builder dialogBox = new AlertDialog.Builder(SignUpActivity.this);
                            dialogBox.setMessage("These reasons cause errors..."+"\n1. The username has been taken"+"\n2. The username and/or password are of the wrong length (i.e. under 6 characters)"
                                    + "\n3. The phone number is of the wrong length (i.e under 10 digits)")
                                    .setCancelable(false)
                                    .setNegativeButton("Okay", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                ...
                taskInsert.execute("http://www.deepakgyawali.com.np/db_con/register.php/");
            }
        });
    }
}
