 ...
 */
public class MainCourseDetailFragment extends Fragment {
    ...
    public MainCourseDetailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(MainCourseDetailFragment.this.getActivity()));
        ...
        SharedPreferences preferences = MainCourseDetailFragment.this.getActivity().getSharedPreferences(PREFS, 0);
        ...
        btnAddtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        MainCourseDetailFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(MainCourseDetailFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
