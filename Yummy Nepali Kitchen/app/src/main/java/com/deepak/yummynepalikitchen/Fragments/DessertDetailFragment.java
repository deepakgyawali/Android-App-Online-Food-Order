 ...
 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(DessertDetailFragment.this.getActivity()));
        ...
        SharedPreferences preferences = DessertDetailFragment.this.getActivity().getSharedPreferences(PREFS, 0);
        ...
        btnAddtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        DessertDetailFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(DessertDetailFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
