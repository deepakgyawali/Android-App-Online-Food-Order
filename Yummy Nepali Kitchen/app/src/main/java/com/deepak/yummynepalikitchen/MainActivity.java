...
import com.deepak.yummynepalikitchen.Fragments.AppetizersFragment;
import com.deepak.yummynepalikitchen.Fragments.CartFragment;
import com.deepak.yummynepalikitchen.Fragments.DessertFragment;
import com.deepak.yummynepalikitchen.Fragments.DrinksFragment;
import com.deepak.yummynepalikitchen.Fragments.HomeFragment;
import com.deepak.yummynepalikitchen.Fragments.MainCourseFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        FragmentManager manager = getSupportFragmentManager();
        manager.beginTransaction().replace(R.id.content_main, appetizersFragment,
                appetizersFragment.getTag()).addToBackStack("Appetizers").commit();

        } else if (id == R.id.nav_maincourse) {
            MainCourseFragment maincourseFragment = new MainCourseFragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_main, maincourseFragment,
                    maincourseFragment.getTag()).addToBackStack("Main Course").commit();

        } else if (id == R.id.nav_desserts) {
            DessertFragment dessertsFragment = new DessertFragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_main, dessertsFragment,
                    dessertsFragment.getTag()).addToBackStack("Desserts").commit();
