 ...
 */
public class AppetizersDetailFragment extends Fragment {
 ...
 */
    ...
    public AppetizersDetailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(AppetizersDetailFragment.this.getActivity()));
        ...
        SharedPreferences preferences = AppetizersDetailFragment.this.getActivity().getSharedPreferences(PREFS, 0);
        ...
        btnAddtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        ...
                        AppetizersDetailFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(AppetizersDetailFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
